...
# -*- coding: utf-8 -*-
#
# ocamlup documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'ocamlup.tex', 'ocamlup Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'ocamlup', 'ocamlup Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ocamlup', 'ocamlup Documentation',
     author, 'ocamlup', 'One line description of project.',
     'Miscellaneous'),
]
